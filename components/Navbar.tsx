            ...
            <div className="relative hidden md:block">
                <form onSubmit={handleSearch} className="absolute md:static top-10 -left-20 bg-white">
                    <input
                        ...
                        className="bg-primary p-3 md:text-md font-medium border-2 border-gray-100 focus:border-2 focus:border-gray-200 w-[300px] mdLw-[350px] rounded-full md:top-0"
                    />
                    <button
